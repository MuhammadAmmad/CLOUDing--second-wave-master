...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + DatabaseContract.Cloud.TABLE_NAME;
    ...
    public int cloudCount() {
        ...
        int count = db.rawQuery("SELECT _id FROM " + DatabaseContract.Cloud.TABLE_NAME, null).getCount();
        db.close();
        return count;
    }
    ...
    public boolean addCloud(int id, String cloudName, String name, String description, float rating, String imageUri) {
        ...
        if (id != -1) {
            values.put(DatabaseContract.Cloud._ID, id);
        }
        ...
        long newRowId;
        newRowId = db.insert(
                DatabaseContract.Cloud.TABLE_NAME,
                DatabaseContract.Cloud.COLUMN_NAME_NULLABLE,
                values);
    ...
    public List<Cloud> getAllClouds() {
        ...
        Cursor selectAll = db.rawQuery("SELECT * FROM " + DatabaseContract.Cloud.TABLE_NAME, null);
    ...
    public Cloud getCloud(int Id) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor getCloud = db.rawQuery("SELECT * FROM " + DatabaseContract.Cloud.TABLE_NAME + " WHERE _id = ?", new String[]{Id + ""});
        ...
        if (getCloud.getCount() > 0) {
            ...
            singleCloud = new Cloud(cloudId, cloudName, cloudDescription, cloudRating, cloudImageUri);
        }
    ...
    public void deleteCloud(int id) {
        ...
        db.delete(DatabaseContract.Cloud.TABLE_NAME, selection, selectionArgs);
    ...
    public void deleteAllData() {
        ...
        db.delete(DatabaseContract.Cloud.TABLE_NAME, null, null);
